...
USER_INPUT_FIRST_ROUND_MSG = f"Would you like to start the game? Y/N\n >>> "
USER_ROUND_INPUT_MSG = f"Would you like to play another round? Y/N\n >>> "
